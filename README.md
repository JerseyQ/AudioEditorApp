...
A browser-based audio editor that supports:
...
1. Drag and drop an audio file into the import area.
2. Drag the left/right handles on the waveform to set trim bounds.
